...
<script>
    ...
    function add() {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: [w + 'px', h + 'px'],
            content: '/backstage/memo/classify/add' //iframe的url
        });
    }
    ...
    function edit(id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: [w + 'px', h + 'px'],
            content: '/backstage/memo/classify/edit?id=' + id //iframe的url
        });
    }
    ...
    function del(ids) {
        ...
        $.post('/admin/memo/classify/delete', {ids: ids}, function (result) {
            if (result.success) {
                layer.closeAll();
                layer.msg('删除成功');
                reload_data();
    ...
    function table_edit_update(id, field, value) {
        $.post('/admin/memo/classify/update?' + field + '=' + value, {id: id}, function (result) {
            if (result.success) {
                layer.msg('修改成功');
            } else {
                layer.closeAll();
    ...
    function update_isUse(id, isUse) {
        $.post('/admin/memo/classify/update', {id: id, isUse: isUse}, function (result) {
            if (result.success) {
                layer.msg('修改成功');
            } else {
                layer.msg('修改失败');
