...
function reload_data(){
	...
	table.reload('table', {
		 where: {downClassifyId:downClassifyId,q:q},page: {
             curr: 1 //重新从第 1 页开始
         }
    });
}
...
//打开添加窗口
function add(){
	window.open("/backstage/down/add");
}

//打开编辑窗口
function edit(id){
	window.open('/backstage/down/edit?id='+id);
}
...
<script type="text/html" id="format_downClassify">
{{#  if(d.downClassifyId != null){ }}
	 {{ d.downClassify.name }}
{{#  }  }}
</script>


<script type="text/html" id="format_thumbnailImage">
			...
			, element = layui.element; //元素操作
			  table.render({
			   ...
			   cols: [[
			      ...
			      ,{field:'thumbnailImage', title: '缩略图', width:80, templet: '#format_thumbnailImage',style:'font-size: 12px;'}
			      ...
			      ,{field:'displayMode', title: '展示模式', width:70, templet: '#format_displayMode'  }
			      
			      ,{field:'downClassifyId', title: '分类', width:120,templet: '#format_downClassify'  }
