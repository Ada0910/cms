...
<div class="content">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="name" lay-verify="title" autocomplete="off"
                       placeholder="请输入帐号" onkeydown="if(event.keyCode==13) go_login()"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" id="password" lay-verify="title"
                       ...
                       onkeydown="if(event.keyCode==13) go_login()" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn" onclick="go_login()" lay-submit=""
                    lay-filter="demo1">登陆
            </button>
...
<%--
<div
        style="text-align: center; font-size: 13px; color: #525252; padding-top: 30px; "></div>
--%>
