...
<div
        style="height: 60px; width: 100%; background-color: #23262E; display: flex; display: -webkit-flex;">
    <div
            style="width: 200px; text-align: center; vertical-align: middle; overflow: hidden;">
        <a target="_blank" style="display: block;" href="javascript:void()"><img
                alt="图标" style="vertical-align: middle;  "
                src="${config.backstageLogo }"></a>
    </div>
    ...
    <div style="flex: 1; -webkit-flex: 1; ">
        <ul class="layui-nav">
            ...
            <li class="layui-nav-item"><a href="main">刷新页面</a></li>

            <li class="layui-nav-item "><a href="javascript:void();">系统设置</a>
           ...
           <%-- <li class="layui-nav-item"><a href="javascript:;">ada机车哒</a></li>--%>
    ...
    <div
            style="  border-left: 1px solid #befffe; color: #c2c2c2;  background-color: #393D49;">
        <ul class="layui-nav">
            <li class="layui-nav-item"><a href="javascript:;"
