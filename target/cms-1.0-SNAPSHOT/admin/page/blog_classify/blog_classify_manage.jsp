...
<script>
    ...
    function add() {
        ...
        layer.open({
            ...
            shade : 0.8,
            area : [ w + 'px', h + 'px' ],
            content : '/backstage/blog/classify/add' //iframe的url
        });
    }
    ...
    function edit(id) {
        ...
        layer.open({
            ...
            shade : 0.8,
            area : [ w + 'px', h + 'px' ],
            content : '/backstage/blog/classify/edit?id=' + id //iframe的url
        });
    }
    ...
    function del(ids) {
        ...
        $.post('/admin/blog/classify/delete', {
            ids : ids
        }, function(result) {
            if (result.success) {
                layer.closeAll();
    ...
    function table_edit_update(id, field, value) {
        $.post('/admin/blog/classify/update?' + field + '=' + value, {
            id : id
        }, function(result) {
            if (result.success) {
                layer.msg('修改成功');
    ...
    function update_isUse(id, isUse) {
        $.post('/admin/blog/classify/update', {
            id : id,
            isUse : isUse
        }, function(result) {
            if (result.success) {
