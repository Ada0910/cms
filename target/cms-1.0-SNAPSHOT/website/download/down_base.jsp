...
<head>
    ...
    <title>${down.title} - ${config.webName}</title>
            ...
            <div style="padding: 10px; border: 1px solid #dadada; border-radius: 5px; min-height: 500px; background-color: white; width: 873px; float: left; margin-right: 10px;">
                ...
                <div style="overflow: hidden; border-bottom: 1px solid #e6e6e6; padding: 8px 0px 4px 0px;">
					<span class="layui-breadcrumb">
					  ...
					  <a href="/download/list?id=${down.id}">${down.downClassify.name}</a>
                ...
                <div style="overflow: hidden; border-bottom: 1px solid #e6e6e6; padding: 0px 0px 10px 0px;">
                    ...
                    <div style="text-align: center; font-style: normal; color: #999;">
                        [<span style="margin-right: 15px;"><fmt:formatDate value="${down.createDateTime}"
                                                                           pattern="yyyy-MM-dd HH:mm"/></span>
                        <span style="margin-right: 15px;">类别：${down.downClassify.name}</span>
